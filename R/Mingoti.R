...
#' @format Um \code{data.frame} com 200 observações e 9 variáveis, em
#'     que
#'
#' \describe{
#'
...
#'
#' \item{\code{sexo}}{Sexo do indivíduo (0 para mulheres e 1 para
#'     homens).}
#'
...
#'
#'
#' \item{\code{utili}}{Nota atribuída à utilidade do produto.}
#'
#' \item{\code{local}}{Nota atribuída à facilidade de encontrar o
#'    produto.}
#'
#' \item{\code{embal}}{Nota atribuída à embalagem do produto.}
#'
#' }
#' @keywords AnaFat
#' @source MINGOTI (2005) pág. 108.
#' @examples
#'
#' data(MingotiAnA1)
#' str(MingotiAnA1)
#'
#' da <- reshape(MingotiAnA1,
#'               direction = "long",
#'               varying = list(3:9),
#'               v.names = "notas",
#'               timevar = "atributo")
...
#'          xlab = "Atributo", ylab = "Freq",
#'          auto.key = list(space = "top", columns = 5, title = "Nota",
#'                          cex.title = 1),
#'          main = "Distribuição das notas atribuídas ao produto",
#'          strip = strip.custom(factor.levels =
#'                                   c("Mulheres", "Homens")),
#'          scales = list(x = list(labels = c("Sabor", "Aroma", "Cor",
#'                                            "Textu", "Utili", "Local",
#'                                            "Embal"))))
#'
NULL
...
#'
#' \item{\code{venda}}{Nota atribuída ao funcionário referente ao
#'     desempenho nas vendas.}
#'
#' \item{\code{lucro}}{Nota atribuída ao funcionário referente ao
#'     desempenho no lucro da empresa.}
#'
#' \item{\code{clie}}{Nota atribuída ao funcionário referente ao
#'     desempenho na captação de novos clientes.}
#'
...
#'     lógica.}
#'
#' \item{\code{social}}{Nota atribuída à habilidade social do
#'     funcionário.}
#'
...
#' }
#' @keywords AnaFat
#' @source MINGOTI (2005), pág. 123, Ex. 4.2; pág. 126, Ex 4.3.
#' @examples
#'
#' data(MingotiAnA2)
#' str(MingotiAnA2)
...
#'     dos residentes.
#' @format Um \code{data.frame} com 120 observações e 6 variáveis, em
#'     que
#'
#' \describe{
#'
...
#'
#' \item{\code{loc}}{Fator que indica localidade da residência (de 1 a
#'     3).}
#'
...
#'
#' \item{\code{grp}}{Fator que indica o grupo em que a empresa está
#'     situada (1 = se a empresa faliu, 2 = se a empresa não faliu).}
#'
...
#' library(car)
#'
#' scatterplotMatrix(~x1 + x2 + x3 + x4 | grp,
#'                   data = MingotiAnA4,
#'                   reg.line = FALSE,
#'                   spread = FALSE,
#'                   smoother = FALSE)
...
#' @name MingotiAnA5
#' @title Sele\enc{çã}{ca}o de Alunos para um Programa de
#'     P\enc{ó}{o}s-gradua\enc{çã}{ca}o
#' @description Um programa de pós-graduação dividiu 62 candidatos do
#'     ano anterior em 3 grupos: (1) candidatos aprovados, (2)
#'     candidatos na lista de espera e (3) candidatos que não foram
#'     aprovados. Para a nova seleção, os responsáveis pensam em
...
#'     avaliar qualidade.
#' @format Um \code{data.frame} com 109 observações e 10 variáveis, em
#'     que
#'
#' \describe{
#'
...
#'
#' \item{\code{grupo}}{Grupo de desempenho nos teste (0 = médio, 1 =
#'     melhor).}
#'
#' \item{\code{idade}}{Idade do funcionário (em anos completos).}
#'
#' \item{\code{sexo}}{Fator que indica sexo (0 = feminino, 1 =
#'     masculino).}
#'
#' \item{\code{ecivil}}{Fator que indica estado Civil (1 = solteiro, 0 =
#'     não solteiro).}
#'
...
#' library(car)
#'
#' scatterplotMatrix(~ testp + testc + anexp | grupo,
#'                   data = MingotiAnA6,
#'                   reg.line = FALSE,
#'                   spread = FALSE,
#'                   smoother = FALSE)
...
#'     aleatoriamente de cada uma de duas máquinas de empacotamento de
#'     determinada empresa, durante o período de produção.  Foram
#'     registrados os pesos das 20 unidades.
...
#'                   data = MingotiTb3.5, smooth = FALSE)
#'
NULL

#' @name MingotiTb3.7
#' @title Dados de Amostras de Solo
#' @description Dados de 25 amostras de determinado tipo de solo.  Para
#'     cada amostra foram registradas as porcentagens de areia,
#'     sedimentos, argila e a quantidade de material orgânico.
...
#'     (A-F).}
#'
#' \item{\code{renda}}{Renda mensal (em quantidade de salários
#'     mínimos).}
#'
...
#' @description Dados referentes a índices de expectativa de vida,
...
#'
#' \item{\code{expecvida}}{Índice baseado na esperança de vida, medindo
#'     a realização relativa de um país na esperança de vida ao nascer.}
#'
#' \item{\code{educ}}{Índice referente ao nível de educação, medindo a
#'     realização relativa de um país tanto na alfabetização de adultos
#'     quanto na escolarização bruta combinada dos níveis primário,
#'     secundário e superior.}
#'
#' \item{\code{pib}}{Índice baseado no PIB, calculado utilizando o PIB
#'     per capita ajustado (dólares).}
#'
#' \item{\code{estabpoli}}{Índice baseado na percepção da probabilidade
#'     de desestabilização (tensões étnicas, conflito armado, etc).}
#'
#' }
#' @keywords AnaAgrup
#' @source MINGOTI (2005), pág. 184.
#' @examples
#'
#' data(MingotiTb6.8)
#' str(MingotiTb6.8)
