...
#'     dose-resposta. Foram 50 animais \emph{Ceriodaphnia dubia}
#'     (pequeno invertebrado de água doce) submetidos a 5 diferentes
...
#'     \describe{
#' 
#' \item{\code{dose}}{Número inteiro que representa a dosagem de
#'     \emph{Nitrofen} aplicada, em mg/l}
#' 
...
#'     310 mg/l) e estimar as médias para cada fator.
#'
#' @keywords contagem
