...
#'              realizado no município de Santo Antonio de Goiás (GO). Houveram 
#'              três cultivares testemunhas e mais seis em cada ensaio.
#'              Cada experimento foi conduzido no período de inverno, sob
#'              irrigação por aspersão. Os dados são relativos à 
...
#'
#' }
#' @keywords DBC feijão plantas grãos produtividade
#' @source  Zimmermann, F.J.(2004), Estatística aplicada à pesquisa 
#'          agrícola (1st ed.). Santo Antônio de Goiás, GO: Embrapa 
#'          Arroz e Feijão. (pg 258)
#' @examples
#'
#' library(lattice)
#'
