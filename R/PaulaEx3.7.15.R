...
#' 
#' @format Um \code{data.frame} com 50 emparelhamento e 14 variáveis
#'
#' \describe{
#'
#' \item{\code{est}}{Identificação do estrato.}
#' 
#' \item{\code{obs}}{Identificação da observação - (1:caso, 2:controle).}
#' 
#' \item{\code{idade}}{Idade do paciente no momento da entrevista em anos.}
#'
#' \item{\code{diag}}{Identificação do diagnóstico (1:caso, 0:controle).}
#' 
...
#'                  PaulaEx3.7.15$obs <- as.factor(PaulaEx3.7.15$obs),
...
#' 
#' pairs(~ obs + idade + diag + tesc + gesc + cur + ipg + idmens 
#'       + numab + numfi + peso + idupmens + ec,
#'       data = PaulaEx3.7.15, 
#'       main = "Matriz das variáveis do tumor benigno na mama")
NULL