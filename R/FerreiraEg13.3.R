...
#'     ferro \emph{Fe} em ppm obtidos em solos de pastagem e de floresta
#'     na região amazônica.
...
#'     pastagem.}
#' 
#' \item{\code{zinco}}{Teor de zinco (\emph{Zn}) do solo, medido em ppm.}
#' 
#' \item{\code{ferro}}{Teor de ferro (\emph{Fe}) do solo, medido em ppm.}
#' 
#' }
#' @keywords AnaDisc
