...
#' @format \code{data.frame} com 20 observações e 2 variáveis, em que
#'
#' \describe{
#'
#' \item{conc}{Concentração de hemoglobina.}
#'
#' \item{linf}{Contagem de linfócitos}
#'
#' }
#' @keywords hemograma
#' @source Ferreira, D. F. (2011). Estatística Multivariada (2nd
#'     ed.). Lavras, editora UFLA. (Exemplo 3.4)
#'
