#' @name ZimmermannTab3.12
#' @title Dados de matéria seca em plantas 
#' @description Experimento em DIC, que estudou a produção de matéria
#'              seca em plantas, em gramas. No experimento foram utilizados 
#'              cinco vasos, quatro tratamentos e três plantas (parcelas) para 
#'              cada vaso e tratamento.  
#' @format Um \code{data.frame} com 75 observações e 4 variáveis
#'
#' \describe{
#'
#' \item{trat}{Fator de níveis numéricos. Tratamento aplicado em plantas.}
#'
...
#'
#' }
#' @keywords DIC plantas parcelas
#' @source  Zimmermann, F.J.(2004), Estatística aplicada à pesquisa 
#'          agrícola (1st ed.). Santo Antônio de Goiás, GO: Embrapa 
#'          Arroz e Feijão. (pg 62)
#' @examples
#'
#' library(lattice)
#'
#' data(ZimmermannTab3.12)
#'
