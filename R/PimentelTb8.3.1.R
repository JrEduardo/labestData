...
#' @title Grupo de Ensaios de Batatinha
...
#'     diferentes variedades de batatinha.}
#'
#' \item{\code{exper}}{Fator de 7 níveis qualitativos, que refere-se aos
#'     diferentes experimentos.}
#'     
#' \item{\code{totais}}{Totais de variedades e quadrados médios
#'     residuais.}
#'
#' }
#' @keywords GE
#' @source Pimentel-Gomes, F. (2009). Curso de Estatística
#'     Experimental (15th ed.). Piracicaba, SP: FEALQ. (Tabela 8.3.1)
#' @examples
#'
#' library(lattice)
#'
