#' @name RamalhoEg12.10
#' @title Crescimento para o Feijoeiro
...
#' \describe{
#'
#' \item{\code{prog1}}{Fator que indica o progenitor 1 do cruzamento.}
#'
#' \item{\code{prog2}}{Fator que indica o progenitor 2 do cruzamento.}
#'
