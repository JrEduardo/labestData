#' @name FerreiraEg9.1
#' @title Avaliação de Areia e Argila para Diferentes Usos da Terra na
#'     Amazônia
...
#' @format Um \code{data.frame} com 6 observações e 2 variáveis.
#'     \describe{
#' 
...
#'            panel.xyplot(x, y, ...)
#'            ltext(x, y, labels = rownames(FerreiraEg9.1),
