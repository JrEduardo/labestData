#' @name AndradeTb2.26
#' @title Local de Coleta e Peso de Mexilhões
...
#'
#' \item{\code{Peso}}{Fator de 3 níveis qualitativos que indica os pesos
#'     dos mexilhões, em gramas.}
#'
...
#'        data = AndradeTb2.26,
#'        type = "b",
#'        auto.key = list(title = "Peso",
#'                        cex.title = 1.1,
#'                        columns = 3),
#'        xlab = "Local de Coleta",
#'        ylab = "Frequência")
#'
NULL