...
#'     confundimento da interação de quarta ordem (M*A*C*D*I). 
#'     Estudou-se os cinco principais problemas da cultura: controle de
#'     invasoras, adubação, irrigação, controle de doenças e cultivar. Do
#'     experimento original, está-se utilizando apenas a primeira repetição,
#'     e a interação de quarta ordem (5 fatores) foi confundida com blocos. 
#'     Os dados da produtividade do arroz estão em kg/ha, e M = manejo da
#'     irrigação (0 = permanente e 1 = intermitente), A = adubação (0 = 30kg/ha
#'     e 1 = 60kg/ha de N), C = cultivar (0 = IAC 435 e 1 = IR 841-63-5-1-9-33),
#'     D = controle de doenças (0 = sem controle e 1 = aplicação de Manzate) 
#'     e I = controle de invasoras (0 = Stam F-34 e 1 = Ronstar).   
...
#'
#' aggregate(prod ~ bloco, data = ZimmermannTb11.19, 
