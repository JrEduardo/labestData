...
- [Guia de Estilo R](#guia-de-estilo-r)
    ...
    - [Documentação de funções na função](#documentao-de-funes-na-funo)
...
desperdício de tempo tentar compreender um código que não está
...
uma tabulação (que não devem se usada).  Para mudar o número de
